...
const Service = () => {
  return (
    <div className="bg-white overflow-hidden my-8">
              ...
              <figure>
                <div className="aspect-w-12 aspect-h-7 lg:aspect-none">
                  <Image
                    ...
                    src="https://res.cloudinary.com/lagalm/image/upload/v1660168611/lagalm_3_pcemks.jpg"
                ...
                <figcaption className="mt-3 flex text-sm text-gray-500">
                  <LightningBoltIcon
                    ...
                    aria-hidden="true"
                  />
                  <span className="ml-2">Manufactura de productos</span>
                </figcaption>
              </figure>
            </div>
          </div>
          <div className="mt-8 lg:mt-0">
            <div className="text-base max-w-prose mx-auto lg:max-w-none">
              <p className="text-lg text-gray-500 text-justify">
                Ofrecemos soluciones y servicios de manufactura especializados
                en el área de moldeo por inyección de resinas termoplásticas,
            ...
            <div className="mt-5 prose prose-indigo text-gray-500 mx-auto lg:max-w-none lg:row-start-1 lg:col-start-1">
              <ul role="list">
                ...
                <li>
                  - Decorado e impresión, por hot stamping, láser o inyección de
                  tinta.
                </li>
                <li>
                  - Procesos de trazabilidad e identificación con grabado láser
